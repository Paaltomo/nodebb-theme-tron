...
<div class="row"><div widget-area="header" class="col-lg-12 col-sm-12"></div>></div>
			...
			<div class="<!-- IF categories.class -->{categories.class}<!-- ELSE -->col-md-3 col-sm-6 col-xs-12<!-- ENDIF categories.class --> category-item" data-cid="{categories.cid}" data-numRecentReplies="{categories.numRecentReplies}">
				...
				<div class="category-icon">
					...
					<div class="slide-wrapper">
						...
						<div id="slide" style="<!-- IF categories.bgColor -->background-color: {categories.bgColor};<!-- ELSE -->background-color: black<!-- ENDIF categories.bgColor -->
								color: {categories.color};">
